...
train_mode = 'train' #train, validate, make_maps, test
train_types = ['obs']
#train_radii = ['375']#, '15']
train_hazards = ['hail', 'wind']
train_lead_times = [30, 60, 90, 120, 150, 180]
forecast_lengths = [60]#, 120]
num_folds = 5
success_ratio_threshold = 25000

ps_version = 3 #i.e., which probSevere version is being used 2 for v2, 3 for v3, 0 means no ps used
ps_flag = ''#'NoTor'
...
num_training_vars = num_wofs_vars + num_misc_vars + num_ps_vars + num_torp_vars
...
wofs_and_ps_var_dir = '/home/ryan.martz/python_packages/frdd-wofs-phi/wofs_phi'
...
raw_torp_training_dir = "/work/ryan.martz/wofs_phi_data/training_data/predictors/raw_torp" # - training location
torp_dir = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/HWT_W2W_2024_torp"
...
rf_dir = "/work/eric.loken/wofs/2024_update/W2W2024/rf_models"
sr_dir = ""
...
ncdf_save_dir = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/ncdata/W2W_2024"
...
#netcdf files 
png_outdir_forecast = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/ncdata/wofs_viewer/forecast"
png_outdir_warning = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/ncdata/wofs_viewer/warning"

######## Main things to change on cloud#######

#May or may not eventually use these
generate_forecasts = False #Generates the predictors array if True
...
nc_outdir = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/ncdata/W2W_2024"
...
train_fcst_full_npy_dir = "/work/eric.loken/wofs/2024_update/SFE2024/fcst/full_npy_backup"

train_obs_full_npy_dir = "/work/eric.loken/wofs/2024_update/SFE2024/obs/full_npy"

#Path to dat directory for training
train_fcst_dat_dir = "/work/eric.loken/wofs/2024_update/SFE2024/fcst/dat_backup"
train_obs_dat_dir = "/work/eric.loken/wofs/2024_update/SFE2024/obs/dat_new_backup"
...
train_warnings_sampled_dat_dir = '/work/ryan.martz/wofs_phi_data/training_data/warnings/sampled_1d_warnings'
...
real_time_sr_map_dir = '/work/eric.loken/wofs/2024_update/W2W2024/sr_csv'
...
wofs_base_path = "/work2/wof/SummaryFiles" #Obviously, will need to change on cloud
#wofs_base_path = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/wofs" #w2w archived wofs data
...
obs_radii = ["375"]
obs_radii_str = ["375"]
obs_radii_float = [37.5]
final_str_obs_radii = ["375"] #form to use for final ncdf files 

final_hazards = ["wind"] #for naming in final ncdf file 
...
ps_dir = "/work/eric.loken/wofs/probSevere3_data/new_cintineo/PS_json/" # - training dir
#ps_dir = "/work/eric.loken/wofs/probSevere/"
#ps_dir = "/work/ryan.martz/wofs_phi_data/HWT_W2W_2024/probSevere/raw"
...
torp_max_convs = ["torp_prob","torp_age",torp_prob_change_1_str,torp_prob_change_2_str,
                  'azshear_max', 'azshear_max_trend', 'reflectivity_max', 'spectrumwidth_max',
                  'spectrumwidth_max_trend', 'absolute_velocity_max',
                  'absolute_velocity_max_trend', 'vrot', 'cc_max', 'phidp_max']

torp_min_convs = ['cc_min', 'phidp_min', 'reflectivity_min', 'vrot_distance',
                  'divshear_min', 'divshear_min_trend', 'extrapolation_minutes']
...
torp_all_predictors = ['torp_prob','torp_age',torp_prob_change_1_str,torp_prob_change_2_str,
                       ...
                       'divshear_min_trend', 'reflectivity_max', 'spectrumwidth_max',
                       'spectrumwidth_max_trend', 'absolute_velocity_max',
                       'absolute_velocity_max_trend', 'vrot', 'vrot_distance', 'cc_min', 'cc_max',
                       'phidp_min', 'phidp_max', 'reflectivity_min', 'extrapolation_minutes']
